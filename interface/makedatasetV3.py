...
import shutil
import random
from PyQt5.QtWidgets import (QApplication, QGroupBox, QWidget, QLineEdit, QPushButton, QVBoxLayout, QFileDialog, QProgressBar, QRadioButton, QHBoxLayout, QMessageBox, QButtonGroup, QSpinBox, QDialog, QFormLayout, QDialogButtonBox, QLabel, QStackedWidget)
...
class CombinedApp(QWidget):
    ...
    def initUI(self):
        ...
        self.switch_button = QPushButton('Switch to Expert Mode', self)  # Define switch_button as a class attribute
        self.switch_button.clicked.connect(self.switch_mode)
        self.update_switch_button_text()  # Call this method to set the initial text
        
        main_layout = QVBoxLayout()
        main_layout.addWidget(self.switch_button)  # Add switch_button to the layout
    ...
    def switch_mode(self):
        ...
        self.update_switch_button_text()  # Update button text when switching
...
class BasicApp(QWidget):
    ...
    def browse_imagepath(self):
        ...
        if imagepath:
            self.imagepath_input.setText(imagepath)
            self.expert_app.imagepath_input.setText(imagepath)
    ...
    def make_dataset(self):
        ...
        self.expert_app.full_augmentation_radio.setChecked(True)
