...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='models/detect/gelan-e.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'dataset025036/dataset.yaml', help='dataset.yaml path')
    parser.add_argument('--hyp', type=str, default=ROOT / 'temp_hyp/list1/hyp_trial_16.yaml', help='hyperparameters path')
    ...
    parser.add_argument('--evolve', type=int,nargs='?', const='', help='evolve hyperparameters for x generations')
