...
def run(
    ...
    f1_file_path = save_dir / 'f1_scores.txt'
    # 保存f1分数到txt文件
    np.savetxt(f1_file_path, f1, fmt='%f')
    # 或者使用标准的Python文件写入方法
...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/molecule036.yaml', help='dataset.yaml path')
