...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.labelDisplayComboBox = QtWidgets.QComboBox(self.centralwidget)
        self.labelDisplayComboBox.setGeometry(QtCore.QRect(680, 640, 200, 50))
        self.labelDisplayComboBox.setObjectName("labelDisplayComboBox")
        self.labelDisplayComboBox.addItem("显示标注")
        self.labelDisplayComboBox.addItem("不显示标注")
